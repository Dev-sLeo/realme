  ...
  <div class="s-container">
    ...
    <?php if ($has_header) : ?>
      <header class="o-testimonials__header">
        ...
        <?php if ($title !== '') : ?>
          <h2 class="o-testimonials__title title__normal" data-animate="fade-up" data-animate-delay="0.2"><?php echo $title; ?></h2>
        <?php endif; ?>

        <?php if ($text !== '') : ?>
          <div class="o-testimonials__text text__normal" data-animate="fade-up" data-animate-delay="0.3"><?php echo $text; ?></div>
        <?php endif; ?>
      </header>
    <?php endif; ?>

    <div class="o-testimonials__slider" aria-busy="false" data-animate="fade-up" data-animate-delay="0.35">
