    ...
    <?php if ($has_top) : ?>
      <div class="o-unifique__top">
        <div class="o-unifique__content">
          ...
          <?php if ($subtitle !== '') : ?>
            <div class="o-unifique__subtitle subtitulo"><?php echo $subtitle; ?></div>
          <?php endif; ?>
          ...
          <?php if ($text !== '') : ?>
            <div class="o-unifique__text text__normal"><?php echo $text; ?></div>
          <?php endif; ?>
      ...
      <div class="o-unifique__bottom">
        ...
        <?php if (!empty($cards)) : ?>
          <div class="o-unifique__cards" role="list">
            ...
            ?>
              <div class="c-feature o-unifique__card" role="listitem">
                <?php if ($icon_id) : ?>
