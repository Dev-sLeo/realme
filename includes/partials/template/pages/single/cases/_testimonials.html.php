    ...
    <div class="c-case-testimonial__grid">
      ...
      <div class="c-case-testimonial__left">
        <div class="c-case-testimonial__card">
          ...
          <?php if ($logo):
            ...
            if ($logo_id): ?>
              <div class="c-case-testimonial__logo" data-animate="fade-up" data-animate-delay="0.1">
          ...
          <?php if ($company || $location): ?>
            <div class="c-case-testimonial__company" data-animate="fade-up" data-animate-delay="0.2">
              <?php if ($company): ?>
                <p class=" c-case-testimonial__company-name">
                  <?php echo esc_html($company); ?>
                </p>
              <?php endif; ?>

              <?php if ($location): ?>
                <p class="c-case-testimonial__company-location">
        ...
        <?php if ($highlight_text || $highlight_description): ?>
          <div class="c-case-testimonial__highlight" data-animate="fade-up" data-animate-delay="0.3" aria-label="<?php echo esc_attr__('Destaque do case', 'textdomain'); ?>">

            <div class="c-case-testimonial__highlight-icon">
            ...
            <div class="c-case-testimonial__highlight-content">
              <?php if ($highlight_text): ?>
                <p class="c-case-testimonial__highlight-title">
                  <?php echo esc_html($highlight_text); ?>
                </p>
              <?php endif; ?>

              <?php if ($highlight_description): ?>
                <p class="c-case-testimonial__highlight-description">
      ...
      <?php if ($quote || $author || $role || $author_image): ?>
        <div class="c-case-testimonial__right">
          <div class="c-case-testimonial__testimonial" data-animate="fade-up" data-animate-delay="0.4" aria-label="<?php echo esc_attr__('Depoimento', 'textdomain'); ?>">

            <?php if ($quote): ?>
              <blockquote class="c-case-testimonial__quote">
            ...
            <?php if ($author || $role || $author_image): ?>
              <div class="c-case-testimonial__author">
                ...
                <?php if ($author_image):
                  ...
                  if ($author_image_id): ?>
                    <div class="c-case-testimonial__author-image">
                      <?php echo wp_get_attachment_image($author_image_id, 'thumbnail'); ?>
                    </div>
                <?php endif;
                endif; ?>

                <div class="c-case-testimonial__author-info">
                  <?php if ($author): ?>
                  ...
                  <?php if ($role): ?>
                    <p class="c-case-testimonial__author-role">
